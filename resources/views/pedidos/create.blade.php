                    ...
                    <form action="{{route('pedido.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="empresa_address" name="empresa_address"
                                       class="form-control-sm form-control" value="{{old('empresa_address')}}">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" id="referal_name1" name="referal_name1"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" id="referal_res_phone2" name="referal_res_phone2"
                                       class="form-control-sm form-control" value="{{old('referal_res_phone2')}}">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="collection_2" name="collection_2"
                                       class="form-control-sm form-control" value="{{old('collection_2')}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="collection_3" name="collection_3"
                                       class="form-control-sm form-control" value="{{old('collection_3')}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="collection_4" name="collection_4"
                                       class="form-control-sm form-control" value="{{old('collection_4')}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="collection_5" name="collection_5"
                                       class="form-control-sm form-control" value="{{old('collection_5')}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="collection_6" name="collection_6"
                                       class="form-control-sm form-control" value="{{old('collection_6')}}">
