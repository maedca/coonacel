            ...
            <form action="{{route('libra.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="empresa" name="empresa" class="form-control-sm form-control" readonly>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="conferencia" id="conferencia" class="form-control">
                            ...
                            <option value="{{$conferencia->id}}">{{$conferencia->name}}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="cellphone" name="cellphone" class="form-control-sm form-control" value="{{old('cellphone')}}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="vr_cuotas" name="vr_cuotas" class="form-control-sm form-control" value="{{old('vr_cuotas')}}">
                    </div>
