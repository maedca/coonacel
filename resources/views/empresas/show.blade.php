                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group  col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="empleados"
                                       placeholder="Número de empleados" name="empleados" value="{{$empresa->empleados}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="tel" class="form-control form-control-sm" id="tel_ofi"
                                       placeholder="Teléfono de oficina" name="tel_ofi" value="{{$empresa->tel_ofi}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="cel">Celular</label>
                                <input type="cel" class="form-control form-control-sm" id="cel"
                                       placeholder="Teléfono Celular" name="cel" value="{{$empresa->cel}}" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="contacto_2" class="form-control form-control-sm" id="contacto_2"
                                       placeholder="" name="contacto_2" value="{{$empresa->contacto_2}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="cargo_2">Cargo 2</label>
                                <input type="cargo_2" class="form-control form-control-sm" id="cargo_2" placeholder=""
                                       name="cargo_2" value="{{$empresa->cargo_2}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="tel_2">Teléfono 2</label>
                                <input type="tel_2" class="form-control form-control-sm" id="tel_2" placeholder=""
                                       name="tel_2" value="{{$empresa->tel_2}}" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="email">Correo</label>
                                <input type="email" class="form-control form-control-sm" id="email" name="email" value="{{$empresa->email}}" readonly>
                            </div>
                            <div class="form-group col-md-8">
                                <label for="descripcion">Descripción</label>
                                <textarea class="form-control form-control-sm" id="descripcion" rows="3"
                                          name="descripcion" readonly>{{$empresa->descripcion}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="calle" name="calle" value="{{$empresa->calle}}" readonly>
                            </div>

                            <div class="form-group col-md-4">
                                <label for="ciudad">Ciudad</label>
                                <input type="text" class="form-control form-control-sm" id="ciudad" name="ciudad" value="{{$empresa->ciudad}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="municipio">Municipio</label>
                                <input type="text" class="form-control form-control-sm" id="municipio" name="municipio" value="{{$empresa->municipio}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="barrio">Barrio</label>
                                <input type="text" id="barrio" name="barrio" class="form-control-sm form-control" value="{{$empresa->barrio}}" readonly>
                            </div>
                            <div class="form-group col-md-4">
